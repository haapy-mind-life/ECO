...
echo "==> app/core/navigation.py 작성"
...
echo "==> app/views/visualization.py 작성"
...
echo "==> app/data/sample_features.py 작성"
...
echo "==> app/data/data_manager.py 작성"
